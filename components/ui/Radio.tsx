...
function Radio({
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className={`${enabled ? "translate-x-[20px]" : "translate-x-0"} , pointer-events-none inline-block h-[18px] w-[18px] transform rounded-3xl shadow-lg ring-0 transition duration-200 ease-in-out`}
        style={{
          backgroundColor: enabled
            ? !isWatchPage
